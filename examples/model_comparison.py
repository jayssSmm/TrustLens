...
def main():
    ...
    print(f"Model B (LogisticRegression)\n Accuracy: {acc_b:.2%}")
    ...
    # 5. Output
    # -----------------------------
    print("\n[5/5] TrustLens Recommendation Engine\n")

    # Use the official compare API for structured decision support
...
if __name__ == "__main__":
    print("Running TrustLens model comparison showdown...\n")
    main()
